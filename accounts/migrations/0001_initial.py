# Generated by Django 4.1.3 on 2022-12-18 07:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('correct', models.IntegerField(verbose_name="To'g'i javob")),
                ('wrong', models.IntegerField(verbose_name="No\to'g'i javob")),
                ('time_out', models.IntegerField(verbose_name='Vaqt')),
